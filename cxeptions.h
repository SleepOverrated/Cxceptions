...
#ifndef CXCEPTIONS_NO_LOCATION // Allow user to remove location info
	char* file;
	size_t line;
...
#ifdef CXCEPTIONS_NO_LOCATION // Allow user to remove location info
...
// Allow user to remove location info
